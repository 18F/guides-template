...
def pages_front_matter_by_title
...
def update_navigation_data(nav_data, pages_front_matter_by_title)
...
def update_navigation_data_in_config_file(config_path, nav_data)
  lines = []
  in_navigation = false
...
update_navigation_data_in_config_file CONFIG_PATH, nav_data
